function Pythagoras(canvas){
  ...
  this.base_dim = Math.min(this.canvas.width/15,this.canvas.height/15);
...
Pythagoras.prototype = {
  update: function(pos, baseCenterX){
    this.updateOrder(pos);
    this.updateHorizontalPos(pos);
    this.calcVariables();
    this.draw(baseCenterX);
  },
  ...
  draw: function(baseCenterX){
    ...
    this.canvas.ctx.save();
      ...
      this.canvas.ctx.translate((this.canvas.width/4)-(this.base_dim/2)-(this.base_dim/2) + baseCenterX,this.canvas.height - 50);

...
function Kochsnowflake(canvas){
    ...
    this.base_width = this.canvas.width*0.1;
    ...
    //这里的参数可以修改
    this.x_offset = (this.canvas.width-this.base_width)/2.2;
    this.y_offset = (this.canvas.height-( Math.sqrt(3)*(this.base_width*this.ratio)/0.315));
}

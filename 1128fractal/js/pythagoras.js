...
Pythagoras.prototype = {
  ...
  draw: function(){
    ...
    this.ctx.save();
      ...
      // this.ctx.translate((this.canvas.width/2)-(this.base_dim/2),this.canvas.height);

      this.ctx.translate((this.canvas.width/4)-(this.base_dim/2)-(this.base_dim/2),this.canvas.height);
